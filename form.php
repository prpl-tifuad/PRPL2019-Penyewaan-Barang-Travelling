...
<div class="jumbotron jumbotron-fluid alhamdulillah2">
    ...
    <div class="form-group">
        ...
        <input type="number" min=1 max=100 class="form-control" name="jumlahbar" placeholder="Masukkan Jumlah Barang" required>
        <br>
        ...
        <input type="hidden" name="kode" value="<?= $kodebar ?>">
    </div>
