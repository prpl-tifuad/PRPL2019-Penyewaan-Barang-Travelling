...
<div class="jumbotron jumbotron-fluid alhamdulillah2">
  ...
  <div class="tulisan">
    <center>INPUT ADMIN<center>
  </div>
  <div class="containerform2">
    <form action="index.php" method="get">
    <div class="form-group">
        <label for="nambar">Nama Barang</label>
        <input type="text" class="form-control" id="nambar"  placeholder="Masukkan Nama Barang" required>
    </div>
    <div class="form-group">
        <label for="jumlahbar">Jumlah Barang</label>
        <input type="number" min=1 max=100 class="form-control" id="jumlahbar" placeholder="Masukkan Jumlah Barang" required>
    </div>
    <div class="form-group">
        <label for="harga">Harga / 24 jam</label>
        <input type="text" class="form-control" id="lamasewa" placeholder="Masukkan harga" required>
    </div>
