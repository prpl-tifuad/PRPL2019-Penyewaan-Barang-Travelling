...
<div class="container">
    <img src="set hiking1.jpg" class="img">
  </div>
  <div class="containerkiri">
      Set Hiking : 40K / 24 Jam
    <a href="form.php?kodebar=10"><img src="cart.png" class="imgbutton" ></a>
  </div>

  <div class="container2">
    <img src="set hiking2.jpg" class="img">
  </div>
  <div class="containerkanan">
      Jaket : 25K / 24 Jam
    <a href="form.php?kodebar=11"><img src="cart.png" class="imgbutton" ></a>
  </div>
  
  <div class="container3">
    <img src="celana.jpg" class="img">
  </div>
  <div class="containerbawah">
      Celana : 20K / 24 Jam
    <a href="form.php?kodebar=12"><img src="cart.png" class="imgbutton" ></a>
  </div>
</div>  

<div class="buttonnext">
<a href="pakaiantravelling2.php"><button type="button" class="btn btn-success">Next</button></a>
  </div>
